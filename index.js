...
const sessdata = config.SESSION_ID.replace("pappet-MD~", '');
...
console.log("CONNECTING PAPPET MD🧬...");
...
console.log('PAPPET MD CONNECTED TO WHATSAPP ENJOY ✅')

let up = `*╭──────────────●●►*
> *➺ PAPPET MD ᴄᴏɴɴᴇᴄᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʏ ᴛʏᴘᴇ .ᴍᴇɴᴜ ᴛᴏ ᴄᴏᴍᴍᴀɴᴅ ʟɪsᴛ ᴄʀᴇᴀᴛᴇᴅ ʙʏ your name ✅*
...
//================ownerreact==============
if(senderNumber.includes("254799874645")){
if(isReact) return
m.react("👑")
}
if(senderNumber.includes("254799874645")){
...
app.get("/", (req, res) => {
res.send("HEY, PAPPET MD STARTED ✅");
});
